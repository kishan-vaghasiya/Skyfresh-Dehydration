    ...
    <div>
      ...
      <div className="product-details-container">
        ...
        <div className="product-info">
          ...
          <p className="weight"><strong>Weight:</strong> {product.weight}</p>
          <p className="origin"><strong>Origin:</strong> {product.origin}</p>
          <p className="packaging"><strong>Packaging:</strong> {product.packaging}</p>
